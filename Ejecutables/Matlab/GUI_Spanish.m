%%=======================================================================%%
%          Graphical User Interface for Chile Waterresources project
%                             Version 4/4/2014
%%=======================================================================%%
...
%==========================================================================
function varargout = GUI_Spanish(varargin)
clc
disp('===========================================');
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GUI_Spanish_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_Spanish_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% Executes just before GUI_Spanish is made visible.
    function GUI_Spanish_OpeningFcn(hObject, eventdata, handles, varargin)
    handles.output = hObject;
    guidata(hObject, handles);

% Outputs from this function are returned to the command line.
    function varargout = GUI_Spanish_OutputFcn(hObject, eventdata, handles) 
